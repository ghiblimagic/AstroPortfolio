    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-12">
        <Project
          ...
          projectDescription={`Finally there's an app to easily connect with a service provider for everyday needs such as: plumbing, cleaning, lawn care and moving! 
        ...
        <Project
          ...
          projectDescription={`An app to easily filter through technical resources so you can find the 'banger' resources you need! Spend less time finding the best resources (or looking for an old resource you love) and more time learning. 
        ...
        <Project
          ...
          vidTitles={"Video of the Homeward Tails website"}
          projectTitle={"Homeward Tails"}
          projectLanguages={
            " Next.js 13, React, Next-Auth, JavaScript, Tailwindcss, CSS, HTML5, MongoDB, Mongoose, Cloudinary, Node Mailer, SendGrid, SWR"
          }
          projectDescription={`A baby name site for pets! Our misison? Help adoption counselors increase pet adoptions with impactful, unique and fun adoption bios. 
        ...
        <Project
          ...
          projectDescription={`A WordPress site for a client's photobooth business hosted with Digital Ocean.
